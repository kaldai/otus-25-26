...
public class NumbersClient {
    ...
    private final AtomicBoolean hasNewValue = new AtomicBoolean(false);
    ...
    public void startCalculation() throws InterruptedException {
        ...
        for (int i = 0; i <= 50; i++) {
            ...
            if (hasNewValue.compareAndSet(true, false)) {
                // Используем последнее значение от сервера только один раз
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        NumbersClient client = new NumbersClient("127.0.0.1", 8980);
        try {
